...
namespace SharpNeat.Domains.SnakeGame.Experiment
{
    ...
    /// </summary>
    public class SnakeExperimentSmart : IGuiNeatExperiment
    {
        ...
        int _maxTicksWithoutEating;	// Length of time agent can survive w/out eating prey. rule of thumb: height x width + _ticksBetweenFood
        string _description;
        ParallelOptions _parallelOptions;

        int _msBetweenTicks = 50;
        int _trialsPerEvaluation = 10;

        string _inputMapperName = "Grid";
        string _outputMapperName = "MultipleOutput";

        SimpleSnakeWorldParams _swparams;
        ...
        {
            get { return _inputMapper.InputCount; }
        }
        ...
        {
            get { return _outputMapper.OutputCount; }
        }
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            SnakeGameEvaluatorSmart evaluator = new SnakeGameEvaluatorSmart(_swparams, _inputMapper, _outputMapper, _trialsPerEvaluation, _maxTicksWithoutEating);
